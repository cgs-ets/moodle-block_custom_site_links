...
namespace block_custom_site_links\output;
...
class mobile {
    ...
    public static function mobile_course_view(array $args) {
        ...
        $blockinstanceid = self::find_blockinstanceid($course, 'custom_site_links');
        if (empty($blockinstanceid)) {
            // return early with no content.
            return ['templates' => [['id' => 'custom_site_links_content','html' => ' ']]];
        }
